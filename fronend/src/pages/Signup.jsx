          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-3 md:py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 text-base md:text-sm"
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-3 md:py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-base md:text-sm"
